...
Untuk menjawab poin ini diperlukan beberapa tahap sebagai berikut:

### Penduga titik rata-rata ketika x1 = 10

Konsep nya mirip dengan input data x1=10 pada model.

```{r}
x.10 <- c(1, 10)
tXb <- t(x.10) %*% b
cat("Penduga titik rata-rata ketika x1=10 adalah", tXb)
```

Didapat $\mathbf{X}'_*\mathbf{b}=12568.22$.
